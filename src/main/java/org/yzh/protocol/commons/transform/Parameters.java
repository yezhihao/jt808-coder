...
public class Parameters {
    ...
    private Map<Integer, Long> parametersLong;
    ...
    public Map<Integer, Long> getParametersLong() {
        return parametersLong;
    }

    public void setParametersLong(Map<Integer, Long> parametersLong) {
